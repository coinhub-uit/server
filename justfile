...
run-dev-local:
  docker compose -f docker-compose/development.local.compose.yaml up --watch

[doc('stop docker compose (local postgres, nestjs dev)')]
stop-dev-local:
  docker compose -f docker-compose/development.local.compose.yaml down

[doc('run with docker compose (local postgres, nestjs prod)')]
run-prod-local:
  docker compose -f docker-compose/development.local.compose.yaml up
